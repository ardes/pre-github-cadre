module KeyEvent
  # include this module in events that require a key event
  #
  # Usage
  #  has_key_event :event
  #
  ...
  # found from these attributes when it is loaded
  #
  # A validation is added to ensuer that the appropriate :event is set and exists in the database
  #
